...
test("phase19 deliverable packager writes deterministic manifests and checksums", async () => {
  ...
  packager.writeBundleRoot(firstBundle, fixture.offer, fixture.sourceContext, firstRefs, {});
  ...
  packager.writeBundleRoot(secondBundle, fixture.offer, fixture.sourceContext, secondRefs, {});
