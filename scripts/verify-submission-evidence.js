...
function usage() {
  return [
    "Usage:",
    "  node scripts/verify-submission-evidence.js [--offer-id <offer_id>] [--mode full|incremental|rebuild] [--rebuild-derived]",
    "",
    "Modes:",
...
async function main() {
  ...
  if (args.offerId) {
    const result = await manager.verifyOfferEvidence({
